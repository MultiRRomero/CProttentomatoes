...
- (void)makeURLRequest {
    NSString *urlStr = @"http://api.rottentomatoes.com/api/public/v1.0/lists/movies/box_office.json?apikey=3pbd23xkdwawk587eva9ubkr";
...
- (UITableViewCell *)tableView:(UITableView *)tableView
    ...
    cell.uiImageView.image = nil; // flush the cached image
      ...
      ^(NSURLRequest *request, NSHTTPURLResponse *response, UIImage *image) {
          if (!request) {
              ...
              [UIView transitionWithView:cell.uiImageView
                              ...
                              animations:^{ cell.uiImageView.image = image; }
                              completion:nil];
          }
      } failure:nil];
